        ...
        <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                ...
                <AdminModule 
                    ...
                    link='super-admin/live-management'
                    statLabel='live'
                    bg='bg-orange-500'
    ...
    return (
        <div className='border p-4 rounded-lg'>
            <div className='flex gap-4 items-center'>
                <div className={ `p-2 rounded-xl flex items-center justify-center ${ bg }` }>{ Icon }</div>
                <div>
