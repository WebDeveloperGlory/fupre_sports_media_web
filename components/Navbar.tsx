...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 justify-center pt-4 px-4 pointer-events-none hidden md:flex">
        <nav
          className={cn(
        ...
        >
          ...
          >
            ...
            <Link
              href={isAuthenticated ? "/profile" : "/new-auth/login"}
                ...
                {isAuthenticated ? (
                  <>
                    ...
                    <button
                      ...
                      className="flex items-center gap-3 px-4 py-3 rounded-xl w-full text-left text-rose-500 hover:bg-rose-500/10 transition-colors"
                    >
