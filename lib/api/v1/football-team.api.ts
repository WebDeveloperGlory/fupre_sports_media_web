...
import { FootballPlayerContractResponse } from '../../types/v1.response.types';
...
export const footballTeamApi = {
    ...
    getTeamPlayersContracts: (id: string, page: number, limit: number) => apiClient.getPaginated<FootballPlayerContractResponse>(`/v1/football/team/${id}/player/contracts?page=${page}&limit=${limit}`),
